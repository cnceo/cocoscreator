...
class View extends BaseView{
    ...
    showTip()
    {
        ...
        this.ui.sprite_bg.node.setContentSize(this.model.contentSize.x,this.model.contentSize.y);
        this.ui.lbl_Context.node.setContentSize(this.model.contentSize.x,this.ui.lbl_Context.node.getContentSize().height);
    }
}
