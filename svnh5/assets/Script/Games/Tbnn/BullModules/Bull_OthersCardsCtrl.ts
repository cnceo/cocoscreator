...
class Model extends BaseModel{
	...
	constructor()
	{
        ...
        this.cardOffRate = BullConst.config.minCardOffWRate;
...
class View extends BaseView{
	...
	initUi()
	{
        ...
        this.model.seatsCount = this.ui.node_givePos.children.length;
    }
    ...
    giveCards (viewSeatId:number, giveNum:number){
        ...
        moveTime = BullConst.config.cardMoveTime;
        intervalTime = BullConst.config.cardIntervalTime;
