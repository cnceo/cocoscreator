...
class View extends BaseView{
	...
	showComponents(){
        var rpparr=[
            ...
            ctrl.rpp_insertwater,ctrl.rpp_applyDissolutionRoom,
        ...
        var prefabarr=[
            ...
            ctrl.Prefab_InsertWater,ctrl.Prefab_applyDissolutionRoom,
...
export default class QgmjRoomCtrl extends BaseCtrl {
    ...
    @property(cc.Prefab)
    Prefab_applyDissolutionRoom=null;
	...
	btn_exit_cb( ){
		if (RoomMgr.getInstance().bGameIsStated) {
			...
			FrameMgr.getInstance().showDialog('游戏已经开始了,此时解散房间将不退还房卡!',okcb.bind(this)); 
