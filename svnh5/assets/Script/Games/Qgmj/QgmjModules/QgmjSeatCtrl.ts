...
class Model extends BaseModel{
	...
	updateZhuang()
	{ 
		this.isZhuangJia=QgmjLogic.getInstance().zhuangseat==this.logicseatid;
	}
	recover()
	{
		this.updateZhuang();
...
//c, 控制
@ccclass
export default class QgmjSeatCtrl extends BaseCtrl {
	//这边去声明ui组件
    @property
    seatId:Number = 0;
    @property(cc.Node)
	...
	onEnterRoom(msg){ 
		...
		QgmjAudio.getInstance().OtherPlayerEnterAudio();
		console.log("Enter")
	}
