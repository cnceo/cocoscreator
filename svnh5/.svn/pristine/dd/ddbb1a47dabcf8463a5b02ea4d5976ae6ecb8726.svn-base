...
export default class RoomMgr extends BaseMgr{
    ...
    constructor (){
        ...
        this.routes = {
            ...
            'room.roomHandler.disbandRoom':this.room_roomHandler_disbandRoom, 
    ...
    {
        // body
        this.send_msg('room.roomHandler.disbandRoom');
    }
    exitRoom()
    {
        // body
    ...
    {
        this.notify_msg('room.roomHandler.applyDissolutionRoom');
    }
    agreeDissolutionRoom()
    {
        this.notify_msg('room.roomHandler.agreeDissolutionRoom');
    }
    refuseDissolutionRoom()
    {
        this.notify_msg('room.roomHandler.refuseDissolutionRoom');
    }
    ...
    {  
        let logicseatid = (target_seatid + this.myseatid)%this.roominfo.seatcount;
    ...
    {
        // body
        let viewseatid = (logicSeatId-this.myseatid+this.roominfo.seatcount)%this.roominfo.seatcount; 
        return viewseatid;
    }
    ...
    {   
        console.log("收到服务器http_reqRoomEntry=",msg)
