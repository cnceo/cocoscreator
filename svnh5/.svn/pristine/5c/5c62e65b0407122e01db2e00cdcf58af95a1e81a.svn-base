...
import Prefab_bull_settleCtrl from "./Prefab_bull_settleCtrl";
...
class Model extends BaseModel{
	...
	constructor()
	{
        ...
        this.cardOffRate = BullConst.config.bigCardOffWRate;
...
class View extends BaseView{
    ...
    giveCards (giveNum:number){
        ...
        moveTime = BullConst.config.cardIntervalTime;
        intervalTime = BullConst.config.cardMoveTime;
    ...
    showTiShi (){
        ...
        G_FRAME.globalEmitter.emit('modules_showResultType', resultObj.resultType)
...
export default class Bull_MyCardsCtrl extends BaseCtrl {
	...
	{
        this.n_events = {};
        this.n_events[BullConst.clientEvent.onGiveCards] = this.onStartGive;
    ...
    */
    onStartGive(msg){
        ...
        //延时后打开算牌ui
        let time = BullConst.config.cardIntervalTime*BullConst.config.maxGroupCardsNum+BullConst.config.cardMoveTime;
    ...
    */
    onSettle_bull(msg){
        ...
        //显示结算
        this.start_sub_module(G_MODULE.Bull_settle, (uiCtrl:Prefab_bull_settleCtrl)=>{
    ...
    private node_btn_tanpai_cb(curNode:cc.Node){
        ...
        BullLogic.getInstance().sendTanpai();
    }
    //点击摊牌提示
