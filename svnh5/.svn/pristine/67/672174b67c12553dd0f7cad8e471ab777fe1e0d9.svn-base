...
export default class QgmjResMgr{
    ...
    private audioPath = 'res/raw-assets/resources/audio/Games/qgmj/Pth/man/';
    private voicePath = 'res/raw-assets/resources/audio/Games/qgmj/dialogue/';
    jin=null;  
   
    private static _instance:QgmjResMgr;
    ...
    public static getInstance ():QgmjResMgr{
        if(!this._instance){
            this._instance = new QgmjResMgr();
        }
    ...
    {
        let index = QgmjResMgr.huaIcons[value];  
        var texture=cc.loader.getRes(cc.url.raw(`resources/Games/Qgmj/BuhuaStatus_${index}.png`));     
        return texture;
    }
    getCardTextureByValue(value)
    {
        ...
        var cardName= QgmjResMgr.cardpngs[value];
        var texture=cc.loader.getRes(cc.url.raw(`resources/Games/Qgmj/MaJiang2d/${cardName}.png`)) 
        return texture;
    }
    ...
    get3DCardTextureByValue(value)
    {
        ...
        var cardName= QgmjResMgr.cardpngs[value];
        var texture=cc.loader.getRes(cc.url.raw(`resources/Games/Qgmj/MaJiang3d/${cardName}.png`))
        return texture;
    }
    //吃碰杠声音
    public getAudioByName(name:string){
        var audioList= QgmjResMgr.OpAudioPath[name];
        if(!audioList){
    ...
    public getProcessAudioByName(name:string){
        var audioList= QgmjResMgr.ProcessAudioPath[name];
        if(!audioList){
            console.log(`#error name = ${name}`);
            return;
        }
    ...
    public getCardAudioByName(opName:string,cardName:string){
        var cardAudioList= QgmjResMgr.OpAudioPath[opName];
        if(!cardAudioList){
    ...
    public getClockAudio(){
        return 'res/raw-assets/resources/audio/Games/qgmj/Clock.mp3';
    }

    public getDiceAudio(){
        return 'res/raw-assets/resources/audio/Games/qgmj/dice.mp3';
    }

    public getOtherPlayerEnterAudio(){
        return 'res/raw-assets/resources/audio/Games/qgmj/other_player_enter.mp3';
    }

    public getOtherPlayerLeaveAudio(){
        return 'res/raw-assets/resources/audio/Games/qgmj/other_player_leave.mp3';
    }

    public getWinAudio(){
        return 'res/raw-assets/resources/audio/Games/qgmj/Win.mp3';
    }

    public getLostAudio(){
        return 'res/raw-assets/resources/audio/Games/qgmj/Lost.mp3';
    }

    //0 本地 1普通话
    public setPathKind(type:number){
        if(type == 1)this.audioPath = 'res/raw-assets/resources/audio/Games/qgmj/PuTongHua/man/';
        else this.audioPath = 'res/raw-assets/resources/audio/Games/qgmj/Pth/man/';
    }
}
